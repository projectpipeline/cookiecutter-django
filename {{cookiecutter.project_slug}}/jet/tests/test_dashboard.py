...
from apps.jet.dashboard.dashboard import Dashboard
from apps.jet.dashboard.modules import LinkList, RecentActions
from apps.jet.dashboard.models import UserDashboardModule
from apps.jet.tests.dashboard import TestIndexDashboard
