...
from apps.jet.templatetags.jet_tags import jet_select2_lookups, jet_next_object, jet_previous_object
from apps.jet.tests.models import TestModel, SearchableTestModel
